...
仍未完成 1440×900、1280×800、768×1024、390×844 的完整矩阵，也未完成独立 console 报告。2026-09-11 已通过本地 favicon 与 Leaflet layers SVG 收口 `/favicon.ico`、`layers-2x.png` 的已知缺口；完整静态资源盘点、marker 默认图标验证和 console/E2E 仍待后续切片。
